...
public class Player extends Entity{
    ...
    /**
     * Retrieves a list of spells that the player can currently use.
     * A spell is considered usable if its mana cost is less than or equal to the player's current mana.
     *
     * @return A list of usable spells.
     */
